...
- Dataset id: `newer_college`
- Tier: `2`
- Domain: `lidar_visual_inertial_mapping`
- MASS relevance: `medium`
- Expected format: `ros1_bag_and_extracted_files`
- Target audit level: `L1`
- Download policy: `shortest_sequence`
- Status: `candidate`
...
- original_rosbag_time_vs_extracted_file_time
- sensor_sync_documentation
